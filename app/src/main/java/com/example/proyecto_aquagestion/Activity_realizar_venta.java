...
public class Activity_realizar_venta extends AppCompatActivity {
    ...
    public void cancelar_venta(View view) {
        Toast.makeText(this, "salir venta", Toast.LENGTH_SHORT).show();
        Intent cancelar_venta = new Intent(this, Activity_Menu_Principal.class);
        startActivity(cancelar_venta);
        finish();
    }
}